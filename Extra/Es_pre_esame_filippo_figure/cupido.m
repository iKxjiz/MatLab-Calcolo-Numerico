function main()
    ...
    tol = 1.0e-2;
    cuore = curv2_ppbezier_join(bezS, bezD, tol);
    % stampa intero cuore a tratti
    cuoreCol = curv2_ppbezier_plot(cuore, 40, 'k-',2);
    ...
    frecciaDestra = curv2_ppbezier_join(c, s, 1.0e-2);
    ...
    frecciaDestra = curv2_ppbezier_join(c, frecciaDestra, 1.0e-2);
    ...
    curv2_ppbezier_plot(frecciaSinistra,'g');
    
    % uniamo parte frecciaDestra e frecciaSinistra per ottenere la freccia
    % completa
    freccia = curv2_ppbezier_join(frecciaSinistra, frecciaDestra, 1.0e-2);
    ...
    frecciaD = curv2_ppbezier_join(frecciaD, scsx, 1.0e-2);
    Px = curv2_ppbezier_plot(frecciaD, np);
    point_fill(Px, 'b', 'r', 1.5);
end